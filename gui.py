...
sheets=['aa','bb','ccaaaaaaaaaaaaaaa']
...
ef_browse = ttk.Button(ef, text='Browse', takefocus=False) #excel file browse button
...
cg_entry = ttk.Entry(cg, textvariable=exc_var, takefocus=False) #excel file entry input
...
cg_browse = ttk.Button(cg, text='Browse', takefocus=False) #excel file browse button
...
op_entry = ttk.Entry(op, textvariable=exc_var, takefocus=False) #excel file entry input
...
op_browse = ttk.Button(op, text='Browse', takefocus=False) #excel file browse button
